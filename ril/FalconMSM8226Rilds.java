...
/**
 * RIL customization for Motorola Moto G Dual-sim devices
 *
 * {@hide}
 */
public class FalconMSM8226Rilds extends RIL implements CommandsInterface {
    ...
    public FalconMSM8226Rilds(Context context, int networkMode, int cdmaSubscription,Integer instanceId) {
    ...
    responseCallList(Parcel p) {
        ...
        for (int i = 0 ; i < num ; i++) {
            ...
            int call_type = p.readInt();            // Motorola CallDetails
            int call_domain = p.readInt();          // Motorola CallDetails
            String csv = p.readString();            // Motorola CallDetails
