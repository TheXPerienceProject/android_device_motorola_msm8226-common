...
/**
 * RIL customization for Motorola Moto G Single-sim devices
 *
 * {@hide}
 */
public class FalconMSM8226Ril extends RIL {
    ...
    public FalconMSM8226Ril(Context context, int networkMode, int cdmaSubscription) {
    ...
    responseCallList(Parcel p) {
        ...
        for (int i = 0 ; i < num ; i++) {
            ...
            boolean isVideo = (0 != p.readInt());   // Motorola CallDetails
